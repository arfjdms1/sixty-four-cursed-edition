...
import type { VFX } from '../engine/effects/VFX.js'
...
import type { SaveSystem } from '../engine/save/SaveSystem.js'
import type { AudioSystem } from '../engine/audio/AudioSystem.js'
import type { EffectSystem } from '../engine/effects/EffectSystem.js'
import type { InputSystem } from '../engine/input/InputSystem.js'
import type { RenderSystem } from '../engine/rendering/RenderSystem.js'
import type { MouseState, PointerInput } from '../engine/input/types.js'
import type { PlayingSound, SoundState, DecodedAudioSample as AudioSample } from '../engine/audio/types.js'
import type { AnalyticsState } from '../engine/resources/types.js'
import type { ResourceSystem } from '../engine/resources/ResourceSystem.js'
import type { EntityManager } from '../engine/entities/EntityManager.js'
import type { InteractionSystem } from '../engine/interaction/InteractionSystem.js'
import type { AutonomySystem } from '../engine/autonomy/AutonomySystem.js'
import type { WorldEventSystem } from '../engine/events/WorldEventSystem.js'
...
export type { HollowEvent } from '../engine/events/types.js'
